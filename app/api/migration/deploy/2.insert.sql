...
INSERT INTO ingredient(label, picture, unit, category_id) VALUES
('Farine', './app/api/picture/Farine.jpg', 'mg', 5),
('Levure chimique', './app/api/picture/Levure-chimique.jpg', 'paquet', 5),
('Beurre', './app/api/picture/Beurre.jpg', 'mg', 6),
('Banane', './app/api/picture/Banane.jpg', null, 4),
('Chocolat', './app/api/picture/Chocolat.jpg', 'mg', 5),
('Cardamome', './app/api/picture/Cardamome.jpg', 'pincée', 5),
('Cassonade', './app/api/picture/Cassonade.jpg', 'mg', 5),
('Oeuf', './app/api/picture/Oeuf.jpg', null, 8),
('Lait', './app/api/picture/Lait.jpg', 'ml', 6),
('Sel', './app/api/picture/Sel.jpg', 'pincée', 5),
('Sucre en poudre', './app/api/picture/Sucre-en-poudre.jpg', 'mg', 5),
('Grand-marnier ou de rhum', './app/api/picture/Grand-marnier-ou-de-rhum.jpg', null, 5),
('Pralin', './app/api/picture/Pralin.jpg', 'pincée', 5),
('Glace vanille', './app/api/picture/Glace-vanille.jpg', 'boule', 6),
('Pâte brisée', './app/api/picture/Pâte-brisée.jpg', 'rouleau', 5),
('Crème fraîche', './app/api/picture/Crème-fraîche.jpg', 'mg', 6),
('Lardons', './app/api/picture/Lardons.jpg', 'mg', 3),
('Poivre', './app/api/picture/Poivre.jpg', 'pincée', 5),
('Muscade', './app/api/picture/Muscade.jpg', null, 5),
('Fond de veau', './app/api/picture/Fond-de-veau.jpg', 'ml', 5),
('Comté', './app/api/picture/Comté.jpg', 'mg', 6),
('Maïzena', './app/api/picture/Maïzena.jpg', null, 5),
('Bar', './app/api/picture/Bar.jpg', 'mg', 2),
('Chorizo', './app/api/picture/Chorizo.jpg', 'mg', 3),
('Chapelure', './app/api/picture/Chapelure.jpg', 'mg', 5),
('Carotte', './app/api/picture/Carotte.jpg', 'mg', 1),
('Courgette', './app/api/picture/Courgette.jpg', null, 1),
('Cumin', './app/api/picture/Cumin.jpg', 'c.à.s', 5),
('Patate douce', './app/api/picture/Patate-douce.jpg', 'c.à.s', 1),
('Echalotes', './app/api/picture/Echalotes.jpg', null, 1),
('Ail', './app/api/picture/Ail.jpg', 'gousse', 1),
('Crème coco', './app/api/picture/Crème-coco.jpg', 'ml', 6),
('Pâte de curry rouge', './app/api/picture/Pâte-de-curry-rouge.jpg', 'mg', 5),
('Concentré de tomate', './app/api/picture/Concentré-de-tomate.jpg', 'c.à.s', 5),
('Citron vertes', './app/api/picture/Citron-vertes.jpg', null, 1),
('Oignon', './app/api/picture/Oignon.jpg', null, 1),
('Huile d''olive', './app/api/picture/Huile-d_olive.jpg', 'c.à.s', 5),
('Lentilles vertes', './app/api/picture/Lentilles-vertes.jpg', 'mg', 1),
('Curry', './app/api/picture/Curry.jpg', 'c.à.c', 5),
('Cube de bouillon de poule', './app/api/picture/Cube-de-bouillon-de-poule.jpg', null, 5),
('Laurier', './app/api/picture/Laurier.jpg', 'feuille', 5),
('Potimarron', './app/api/picture/Potimarron.jpg', null, 1),
('Pomme de terre', './app/api/picture/Pomme-de-terre.jpg', null, 1),
('Poivron', './app/api/picture/Poivron.jpg', null, 1),
('Tomate', './app/api/picture/Tomate.jpg', 'mg', 1),
('Safran', './app/api/picture/Safran.jpg', 'dose', 5),
('Riz', './app/api/picture/Riz.jpg', 'mg', 9),
('Filet de poulet', './app/api/picture/Filet-de-poulet.jpg', 'mg', 3),
('Calamar', './app/api/picture/Calamar.jpg', 'mg', 2),
('Moule', './app/api/picture/Moule.jpg', 'ml', 7),
('Crevette', './app/api/picture/Crevette.jpg', null, 7),
('Melon', './app/api/picture/Melon.jpg', null, 4),
('Thym', './app/api/picture/Thym.jpg', 'c.à.c', 5),
('Eau', './app/api/picture/Eau.jpg', 'c.à.s', 5),
('Salade', './app/api/picture/Salade.jpg', 'coeur', 1),
('Feta', './app/api/picture/Feta.jpg', 'mg', 6),
('Jambon cru', './app/api/picture/Jambon-cru.jpg', 'tranche', 3),
('Jus de citron', './app/api/picture/Jus-de-citron.jpg', 'c.à.s', 5),
('Moutarde', './app/api/picture/Moutarde.jpg', 'c.à.s', 5),
('Cheddar', './app/api/picture/Cheddar.jpg', 'mg', 6),
('Bière brune', './app/api/picture/Bière-brune.jpg', 'ml', 5),
('Pain de campagne', './app/api/picture/Pain-de-campagne.jpg', null, 9),
('Jambon blanc', './app/api/picture/Jambon-blanc.jpg', 'tranche', 3),
('Chocolat noir', './app/api/picture/Chocolat-noir.jpg', 'mg', 5),
('Sucre semoule', './app/api/picture/Sucre-semoule.jpg', 'mg', 5),
('Fromage ail et fines herbes', './app/api/picture/Fromage-ail-et-fines-herbes.jpg', null, 6),
('Fajitas', './app/api/picture/Fajitas.jpg', null, 9),
('Penne', './app/api/picture/Penne.jpg', 'mg', 9),
('Herbe de provence', './app/api/picture/Herbe-de-provence.jpg', null, 5);

INSERT INTO recipe(label, picture, rate, difficulty, time) VALUES
('Cake du petit-déjeuner banane-chocolat', './app/api/picture/recipe/Cake-banane-chocolat.jpg', 4.4, 'Très facile', '45 min'),
('Pâte à crêpes (des plus raffinées)', './app/api/picture/recipe/Crepes.jpg', 4.7, 'Facile', '17 min'),
('Bowl cake moelleux chocolat noisettes', './app/api/picture/recipe/Bowl-cake-moelleux-chocolat-noisettes.jpg', 4.5, 'Très facile', '13 min'),
('Quiche lorraine traditionnelle', './app/api/picture/recipe/Quiche-Lorraine.jpg', 4.8, 'Très facile', '35 min'),
('Filet de bar en croûte de chorizo, purée et mousse de haricots cocos de Paimpol', './app/api/picture/recipe/Filet-de-bar-en-croûte.jpg', 4.2, 'Moyenne', '2 h 30 min'),
('Curry de légumes végétarien', './app/api/picture/recipe/Curry-de-légume-végétarien.jpg', 4.8, 'Très facile', '1 h 20 min'),
('Burger végétarien aux lentilles', './app/api/picture/recipe/Burger-vegétarien.jpg', 5, 'Très facile', '55 min'),
('Soupe veloutée de potimarron et pommes de terre', './app/api/picture/recipe/Soupe-potimarron.jpg', 4.9, 'Très facile', '45 min'),
('Paëlla fruits de mer, chorizo et poulet de Patou', './app/api/picture/recipe/Paella-fruit-de-mer-chorizo.jpg', 4.8, 'Facile', '1 h 10 min'),
('Salade melon, feta, jambon', './app/api/picture/recipe/Salade-melon-feta.jpg', 4.8, 'Très facile', '15 min'),
('Welsh traditionnel à la bière brune', './app/api/picture/recipe/Wesh-traditionnel.jpg', 4.3, 'Moyenne', '40 min'),
('Crème dessert facile au chocolat', './app/api/picture/recipe/Creme-dessert.jpg', 4.6, 'Très facile', '15 min'),
('Pancake Moelleux : recette facile', './app/api/picture/recipe/Pancake.jpg', 4.8, 'Très facile', '14 min'),
('Roulé de jambon original pour apéro', './app/api/picture/recipe/Roulé-jambon.jpg', 4.8, 'Très facile', '20 min'),
