...
accountRouter.post("/register", validationModule.validateAccount('body'), account.addAccount);
accountRouter.put("/profile/:id(\\d+)", validationModule.validateAccount('body'), account.updateAccount);
