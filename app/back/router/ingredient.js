...
//Admin
ingredientRouter.get("/admin/ingredient", /*authentification.authenticateToken, validationRole.isAdmin,*/ isAdmin, home.menu, ingredient.getAllIngredientPage);
...
ingredientRouter.post("/admin/ingredient/delete/:id(\\d+)", /*authentification.authenticateToken, validationRole.isAdmin,*/ isAdmin, home.menu, ingredient.deleteIngredient);
