...
//Admin
messageRouter.get("/admin/message", /*authentification.authenticateToken, validationRole.isAdmin*/home.menu, message.getAllMessagePage);
messageRouter.get("/admin/message/:id(\\d+)", /*authentification.authenticateToken, validationRole.isAdmin*/home.menu, message.getMessagePage);
...
messageRouter.post("/admin/message/delete/:id(\\d+)", /*authentification.authenticateToken, validationRole.isAdmin*/home.menu, message.deleteMessage);
