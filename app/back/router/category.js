...
//Admin
categoryRouter.get("/admin/category", /*validationRole.isAdmin*/home.menu, category.getAllCategoryPage);
categoryRouter.get("/admin/category/:id(\\d+)", /*authentification.authenticateToken, validationRole.isAdmin*/home.menu, category.getCategoryPage);
...
categoryRouter.post("/admin/category/delete/:id(\\d+)", /*authentification.authenticateToken, validationRole.isAdmin*/home.menu, category.deleteCategory);
